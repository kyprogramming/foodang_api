...
export function buildDevLogger() {
    return winston.createLogger({
        ...
        transports: [
            ...
            // new winston.transports.MongoDB({ level: 'error', db: MONGODB_CONNECTION_STRING, options: { poolSize: 2, autoReconnect: true, useNewUrlParser: true, useUnifiedTopology: true }, }),
        ],
    });
}
