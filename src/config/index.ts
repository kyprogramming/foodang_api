...
// CLOUDINARY_CLOUD_NAME = dfdjs3umq CLOUDINARY_API_KEY = 732717696381318 CLOUDINARY_API_SECRET = qFzcZhycge9E7liN - Xrkawmf8Tw
// CLOUDINARY_URL = cloudinary://<your_api_key>:<your_api_secret>@dfdjs3umq
